...
function Signup() {
        ...
        return (
            <div className="flex min-h-screen flex-col items-center justify-center bg-background text-foreground">
                <div className="w-full max-w-[420px] rounded-2xl bg-card p-8 shadow-xl border border-border text-center">
                    ...
                    <Link to="/signin" className="block w-full rounded-[10px] bg-primary p-3 font-medium text-primary-foreground transition-all hover:bg-primary/90 shadow-md">
                        Go to Sign In
                    </Link>
                </div>
            </div>
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-background text-foreground">
            <h1 className="mb-6 text-4xl font-bold tracking-tight text-primary">FormEngine</h1>

            <div className="w-full max-w-[420px] rounded-2xl bg-card p-8 shadow-xl border border-border">
                <h2 className="mb-1.5 text-2xl font-bold text-card-foreground">Create an account</h2>
                ...
                <form onSubmit={handleSignup} className="flex flex-col gap-4">
                    <div>
                        <label className="mb-1.5 block text-[13px] font-medium text-foreground">Full Name</label>
                        <input
                    ...
                    <div>
                        ...
                        {email.length > 0 && !isValidGmail && (
                            <p className="mt-1 text-xs text-destructive font-medium">Enter a valid Gmail address</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {password.length > 0 && strength && (
                            <div className="mt-2">
                                ...
                                <p className="mt-1 text-xs text-muted-foreground">Password strength: {strength}</p>
                            </div>
                        )}
                    </div>

                    <div>
                        <label className="mb-1.5 block text-[13px] font-medium text-foreground">Confirm Password</label>
                        <div className="relative">
                            <input
